 ...
 */
public class geek extends Fragment {
    WebView tech2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imag.setImageResource(R.drawable.gfg);
        ...
        tech2.loadUrl("https://www.geeksforgeeks.org");
    ...
    public class myweb extends WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            geek.this.progress.setProgress(0);
            super.onPageStarted(view, url, favicon);
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            geek.this.progress.setProgress(100);
