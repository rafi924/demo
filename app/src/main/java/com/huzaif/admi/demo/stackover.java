 ...
 */
public class stackover extends Fragment {
    WebView tech2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imag.setImageResource(R.drawable.stack);
        ...
        tech2.loadUrl("https://www.stackoverflow.com");
    ...
    public class myweb extends WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            stackover.this.progress.setProgress(0);
            super.onPageStarted(view, url, favicon);
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            stackover.this.progress.setProgress(100);
