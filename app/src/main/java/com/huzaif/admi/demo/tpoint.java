 ...
 */
public class tpoint extends Fragment {
    WebView tech2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imag.setImageResource(R.drawable.tpoint);
        ...
        tech2.loadUrl("https://www.javatpoint.com");
    ...
    public class myweb extends WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            tpoint.this.progress.setProgress(0);
            super.onPageStarted(view, url, favicon);
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            tpoint.this.progress.setProgress(100);
