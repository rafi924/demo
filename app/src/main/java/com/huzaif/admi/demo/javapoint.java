 ...
 */
public class javapoint extends Fragment {
    WebView tech2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imag.setImageResource(R.drawable.logo);
        ...
        tech2.loadUrl("https://www.tutorialspoint.com");
    ...
    public class myweb extends WebViewClient
    {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            javapoint.this.progress.setProgress(0);
            super.onPageStarted(view, url, favicon);
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            javapoint.this.progress.setProgress(100);
